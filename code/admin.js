...
products.forEach((data)=> {
  ...
  <input type="text" class="form-control" id="imgSrc" value="${data.src}">
  </div>
  <div class="mb-3">
  ...
  <div class="modal-footer">
    <button type="button" class="btn btn-success" onClick ="editProd()">Save Changes</button>
  </div>
  </div>
  </div>
  </div>
...
function delProduct (){
  // products.splice (products[data],-1)
